...
class SectionsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.sections.index', compact('articles'));
    }
    ...
    private function refreshUploadedFileData(Article $article, $key, $imageData)
    {
        ...
        $newFileName = str_replace(
            $imageData['file_basename'],
            $article->id . '_' . $key, $imageData['file_name']
        );
    ...
    public function uploadImage(Requests\ImageRequest $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($requestFile->isValid()) {
                ...
                $filePath = $filePath = ArticleImage::storagePath($fileName);
        ...
        return Response::json(compact('fileName', 'filePath', 'fileUrlPattern', 'success', 'errors'));
    }
}
